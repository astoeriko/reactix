...
As reactix depends on JAX. The default install path is appropriate for CPU use, but GPU-enabled JAX setups often need platform-specific installation steps.
